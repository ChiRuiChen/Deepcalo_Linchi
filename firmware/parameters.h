...
// zp2d_conv_8
struct config65 : nnet::padding2d_config {
...
struct config40 : nnet::conv2d_config {
    ...
    static const unsigned n_chan = N_CHAN_65;
    static const unsigned filt_height = 3;
    static const unsigned filt_width = 3;
    static const unsigned kernel_size = filt_height * filt_width;
...
struct config46 : nnet::dense_config {
    static const unsigned n_in = N_SIZE_1_45;
...
// leaky_relu_d1
struct LeakyReLU_config53 : nnet::activ_config {
...
struct config54 : nnet::dense_config {
    static const unsigned n_in = N_LAYER_50;
    static const unsigned n_out = N_LAYER_54;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned strategy = nnet::resource;
...
struct relu_config56 : nnet::activ_config {
    static const unsigned n_in = N_LAYER_54;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 64;
    typedef ap_fixed<18,8> table_t;
