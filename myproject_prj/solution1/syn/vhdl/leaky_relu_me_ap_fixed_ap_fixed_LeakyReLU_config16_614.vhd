...
entity leaky_relu_me_ap_fixed_ap_fixed_LeakyReLU_config16_614 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of leaky_relu_me_ap_fixed_ap_fixed_LeakyReLU_config16_614 is 
    ...
    signal i_0_reg_65 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal i_fu_82_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    myproject_axi_mul_32s_16ns_48_5_1_U66 : component myproject_axi_mul_32s_16ns_48_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    i_fu_82_p2 <= std_logic_vector(unsigned(i_0_reg_65) + unsigned(ap_const_lv13_1));
    icmp_ln1494_fu_97_p2 <= "1" when (signed(tmp_V_reg_127_pp0_iter5_reg) > signed(ap_const_lv32_0)) else "0";
    icmp_ln514_fu_76_p2 <= "1" when (i_0_reg_65 = ap_const_lv13_17A0) else "0";
