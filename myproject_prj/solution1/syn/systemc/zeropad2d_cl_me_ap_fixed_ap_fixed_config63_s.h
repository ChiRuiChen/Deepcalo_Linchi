...
#ifndef _zeropad2d_cl_me_ap_fixed_ap_fixed_config63_s_HH_
#define _zeropad2d_cl_me_ap_fixed_ap_fixed_config63_s_HH_
...
struct zeropad2d_cl_me_ap_fixed_ap_fixed_config63_s : public sc_module {
    ...
    // Module declarations
    zeropad2d_cl_me_ap_fixed_ap_fixed_config63_s(sc_module_name name);
    SC_HAS_PROCESS(zeropad2d_cl_me_ap_fixed_ap_fixed_config63_s);
    ...
    sc_signal< sc_lv<3> > j_6_fu_153_p2;
    sc_signal< sc_lv<3> > j_6_reg_190;
    sc_signal< bool > ap_block_state18;
    sc_signal< sc_lv<4> > j_5_fu_165_p2;
    sc_signal< sc_lv<4> > j_5_reg_198;
    ...
    void thread_j_5_fu_165_p2();
    void thread_j_6_fu_153_p2();
