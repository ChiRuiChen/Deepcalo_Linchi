...
#ifndef _Loop_1_proc681_HH_
#define _Loop_1_proc681_HH_
...
struct Loop_1_proc681 : public sc_module {
    ...
    // Module declarations
    Loop_1_proc681(sc_module_name name);
    SC_HAS_PROCESS(Loop_1_proc681);
    ...
    sc_signal< sc_lv<1> > icmp_ln52_fu_136_p2;
    sc_signal< sc_logic > is_last_0_loc_0_i_out_out_blk_n;
    sc_signal< sc_lv<12> > i_fu_142_p2;
    sc_signal< sc_lv<12> > i_reg_432;
    ...
    sc_signal< sc_lv<1> > tmp_47_fu_302_p3;
    ...
    static const sc_lv<12> ap_const_lv12_9A0;
    ...
    void thread_icmp_ln52_fu_136_p2();
    ...
    void thread_p_Result_1_fu_203_p1();
