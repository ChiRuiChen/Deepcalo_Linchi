...
entity leaky_relu_me_ap_fixed_ap_fixed_LeakyReLU_config25_616 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of leaky_relu_me_ap_fixed_ap_fixed_LeakyReLU_config25_616 is 
...
begin
    myproject_axi_mul_32s_16ns_48_5_1_U104 : component myproject_axi_mul_32s_16ns_48_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
