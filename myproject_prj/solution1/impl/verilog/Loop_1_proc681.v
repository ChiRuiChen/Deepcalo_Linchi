...
wire   [0:0] icmp_ln52_fu_136_p2;
reg    is_last_0_loc_0_i_out_out_blk_n;
wire   [11:0] i_fu_142_p2;
reg   [11:0] i_reg_432;
reg    ap_block_state2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln52_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln52_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln52_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (1'b1 == ap_CS_fsm_state2)))) begin
        grp_fu_133_ce = 1'b1;
    end else begin
        grp_fu_133_ce = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln52_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln52_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln52_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln52_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = (((icmp_ln52_fu_136_p2 == 1'd1) & (is_last_0_loc_0_i_out_out_full_n == 1'b0)) | ((icmp_ln52_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)));
end
...
assign i_fu_142_p2 = (i_0_i_i_i_reg_122 + 12'd1);

assign icmp_ln52_fu_136_p2 = ((i_0_i_i_i_reg_122 == 12'd2464) ? 1'b1 : 1'b0);
...
assign man_V_1_fu_207_p2 = (54'd0 - p_Result_1_fu_203_p1);

assign man_V_2_fu_213_p3 = ((p_Result_s_reg_453[0:0] === 1'b1) ? man_V_1_fu_207_p2 : p_Result_1_fu_203_p1);
...
assign p_Result_1_fu_203_p1 = tmp_i_fu_196_p3;

assign select_ln588_fu_310_p3 = ((tmp_47_fu_302_p3[0:0] === 1'b1) ? 32'd4294967295 : 32'd0);
...
assign tmp_47_fu_302_p3 = bitcast_ln696_fu_299_p1[32'd31];
